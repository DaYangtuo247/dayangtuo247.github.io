(() => {
    ...
    async function loadMermaid() {
        ...
        const PRIMARY_CDN = "https://s4.zstatic.net/npm/mermaid@11.4.1/dist/mermaid.min.js";
        const FALLBACK_CDN = "https://cdn.bytedance.com/npm/mermaid@11.4.1/dist/mermaid.min.js";

        return new Promise((resolve, reject) => {
            const script = document.createElement("script");
            script.src = PRIMARY_CDN;
            ...
            script.onerror = (error) => {
                console.error("Failed to load Mermaid library from primary CDN:", error);
                // 尝试备用 CDN
                const fallbackScript = document.createElement("script");
                fallbackScript.src = FALLBACK_CDN;
